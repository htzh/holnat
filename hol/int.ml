...
let vINTEGER_REAL_OF_INT = prove
...
let vFORALL_INT_CASES = prove
 ((parse_term "!P:int->bool. (!x. P x) <=> (!n. P(&n)) /\\ (!n. P(-- &n))"),
  vMESON_TAC[vINT_IMAGE]);;

let vEXISTS_INT_CASES = prove
 ((parse_term "!P:int->bool. (?x. P x) <=> (?n. P(&n)) \\/ (?n. P(-- &n))"),
  vMESON_TAC[vINT_IMAGE]);;

let vINT_LT_DISCRETE = prove
...
let vINT_ABS_0 = vINT_OF_REAL_THM vREAL_ABS_0;;
let vINT_ABS_1 = vINT_OF_REAL_THM vREAL_ABS_1;;
let vINT_ABS_ABS = vINT_OF_REAL_THM vREAL_ABS_ABS;;
let vINT_ABS_BETWEEN = vINT_OF_REAL_THM vREAL_ABS_BETWEEN;;
let vINT_ABS_BETWEEN1 = vINT_OF_REAL_THM vREAL_ABS_BETWEEN1;;
let vINT_ABS_BETWEEN2 = vINT_OF_REAL_THM vREAL_ABS_BETWEEN2;;
let vINT_ABS_BOUND = vINT_OF_REAL_THM vREAL_ABS_BOUND;;
let vINT_ABS_CASES = vINT_OF_REAL_THM vREAL_ABS_CASES;;
let vINT_ABS_CIRCLE = vINT_OF_REAL_THM vREAL_ABS_CIRCLE;;
let vINT_ABS_LE = vINT_OF_REAL_THM vREAL_ABS_LE;;
let vINT_ABS_MUL = vINT_OF_REAL_THM vREAL_ABS_MUL;;
let vINT_ABS_NEG = vINT_OF_REAL_THM vREAL_ABS_NEG;;
let vINT_ABS_NUM = vINT_OF_REAL_THM vREAL_ABS_NUM;;
let vINT_ABS_NZ = vINT_OF_REAL_THM vREAL_ABS_NZ;;
let vINT_ABS_POS = vINT_OF_REAL_THM vREAL_ABS_POS;;
let vINT_ABS_POW = vINT_OF_REAL_THM vREAL_ABS_POW;;
let vINT_ABS_REFL = vINT_OF_REAL_THM vREAL_ABS_REFL;;
let vINT_ABS_SGN = vINT_OF_REAL_THM vREAL_ABS_SGN;;
let vINT_ABS_SIGN = vINT_OF_REAL_THM vREAL_ABS_SIGN;;
let vINT_ABS_SIGN2 = vINT_OF_REAL_THM vREAL_ABS_SIGN2;;
let vINT_ABS_STILLNZ = vINT_OF_REAL_THM vREAL_ABS_STILLNZ;;
let vINT_ABS_SUB = vINT_OF_REAL_THM vREAL_ABS_SUB;;
let vINT_ABS_SUB_ABS = vINT_OF_REAL_THM vREAL_ABS_SUB_ABS;;
let vINT_ABS_TRIANGLE = vINT_OF_REAL_THM vREAL_ABS_TRIANGLE;;
let vINT_ABS_ZERO = vINT_OF_REAL_THM vREAL_ABS_ZERO;;
let vINT_ADD2_SUB2 = vINT_OF_REAL_THM vREAL_ADD2_SUB2;;
let vINT_ADD_AC = vINT_OF_REAL_THM vREAL_ADD_AC;;
let vINT_ADD_ASSOC = vINT_OF_REAL_THM vREAL_ADD_ASSOC;;
let vINT_ADD_LDISTRIB = vINT_OF_REAL_THM vREAL_ADD_LDISTRIB;;
let vINT_ADD_LID = vINT_OF_REAL_THM vREAL_ADD_LID;;
let vINT_ADD_LINV = vINT_OF_REAL_THM vREAL_ADD_LINV;;
let vINT_ADD_RDISTRIB = vINT_OF_REAL_THM vREAL_ADD_RDISTRIB;;
let vINT_ADD_RID = vINT_OF_REAL_THM vREAL_ADD_RID;;
let vINT_ADD_RINV = vINT_OF_REAL_THM vREAL_ADD_RINV;;
let vINT_ADD_SUB = vINT_OF_REAL_THM vREAL_ADD_SUB;;
let vINT_ADD_SUB2 = vINT_OF_REAL_THM vREAL_ADD_SUB2;;
let vINT_ADD_SYM = vINT_OF_REAL_THM vREAL_ADD_SYM;;
let vINT_BOUNDS_LE = vINT_OF_REAL_THM vREAL_BOUNDS_LE;;
let vINT_BOUNDS_LT = vINT_OF_REAL_THM vREAL_BOUNDS_LT;;
let vINT_DIFFSQ = vINT_OF_REAL_THM vREAL_DIFFSQ;;
let vINT_ENTIRE = vINT_OF_REAL_THM vREAL_ENTIRE;;
let vINT_EQ_ADD_LCANCEL = vINT_OF_REAL_THM vREAL_EQ_ADD_LCANCEL;;
let vINT_EQ_ADD_LCANCEL_0 = vINT_OF_REAL_THM vREAL_EQ_ADD_LCANCEL_0;;
let vINT_EQ_ADD_RCANCEL = vINT_OF_REAL_THM vREAL_EQ_ADD_RCANCEL;;
let vINT_EQ_ADD_RCANCEL_0 = vINT_OF_REAL_THM vREAL_EQ_ADD_RCANCEL_0;;
let vINT_EQ_IMP_LE = vINT_OF_REAL_THM vREAL_EQ_IMP_LE;;
let vINT_EQ_MUL_LCANCEL = vINT_OF_REAL_THM vREAL_EQ_MUL_LCANCEL;;
let vINT_EQ_MUL_RCANCEL = vINT_OF_REAL_THM vREAL_EQ_MUL_RCANCEL;;
let vINT_EQ_NEG2 = vINT_OF_REAL_THM vREAL_EQ_NEG2;;
let vINT_EQ_SGN_ABS = vINT_OF_REAL_THM vREAL_EQ_SGN_ABS;;
let vINT_EQ_SQUARE_ABS = vINT_OF_REAL_THM vREAL_EQ_SQUARE_ABS;;
let vINT_EQ_SUB_LADD = vINT_OF_REAL_THM vREAL_EQ_SUB_LADD;;
let vINT_EQ_SUB_RADD = vINT_OF_REAL_THM vREAL_EQ_SUB_RADD;;
let vINT_LET_ADD = vINT_OF_REAL_THM vREAL_LET_ADD;;
let vINT_LET_ADD2 = vINT_OF_REAL_THM vREAL_LET_ADD2;;
let vINT_LET_ANTISYM = vINT_OF_REAL_THM vREAL_LET_ANTISYM;;
let vINT_LET_TOTAL = vINT_OF_REAL_THM vREAL_LET_TOTAL;;
let vINT_LET_TRANS = vINT_OF_REAL_THM vREAL_LET_TRANS;;
let vINT_LE_01 = vINT_OF_REAL_THM vREAL_LE_01;;
let vINT_LE_ADD = vINT_OF_REAL_THM vREAL_LE_ADD;;
let vINT_LE_ADD2 = vINT_OF_REAL_THM vREAL_LE_ADD2;;
let vINT_LE_ADDL = vINT_OF_REAL_THM vREAL_LE_ADDL;;
let vINT_LE_ADDR = vINT_OF_REAL_THM vREAL_LE_ADDR;;
let vINT_LE_ANTISYM = vINT_OF_REAL_THM vREAL_LE_ANTISYM;;
let vINT_LE_DOUBLE = vINT_OF_REAL_THM vREAL_LE_DOUBLE;;
let vINT_LE_LADD = vINT_OF_REAL_THM vREAL_LE_LADD;;
let vINT_LE_LADD_IMP = vINT_OF_REAL_THM vREAL_LE_LADD_IMP;;
let vINT_LE_LMUL = vINT_OF_REAL_THM vREAL_LE_LMUL;;
let vINT_LE_LMUL_EQ = vINT_OF_REAL_THM vREAL_LE_LMUL_EQ;;
let vINT_LE_LNEG = vINT_OF_REAL_THM vREAL_LE_LNEG;;
let vINT_LE_LT = vINT_OF_REAL_THM vREAL_LE_LT;;
let vINT_LE_MAX = vINT_OF_REAL_THM vREAL_LE_MAX;;
let vINT_LE_MIN = vINT_OF_REAL_THM vREAL_LE_MIN;;
let vINT_LE_MUL = vINT_OF_REAL_THM vREAL_LE_MUL;;
let vINT_LE_MUL_EQ = vINT_OF_REAL_THM vREAL_LE_MUL_EQ;;
let vINT_LE_MUL2 = vINT_OF_REAL_THM vREAL_LE_MUL2;;
let vINT_LE_NEG2 = vINT_OF_REAL_THM vREAL_LE_NEG2;;
let vINT_LE_NEGL = vINT_OF_REAL_THM vREAL_LE_NEGL;;
let vINT_LE_NEGR = vINT_OF_REAL_THM vREAL_LE_NEGR;;
let vINT_LE_NEGTOTAL = vINT_OF_REAL_THM vREAL_LE_NEGTOTAL;;
let vINT_LE_POW2 = vINT_OF_REAL_THM vREAL_LE_POW2;;
let vINT_LE_RADD = vINT_OF_REAL_THM vREAL_LE_RADD;;
let vINT_LE_REFL = vINT_OF_REAL_THM vREAL_LE_REFL;;
let vINT_LE_RMUL = vINT_OF_REAL_THM vREAL_LE_RMUL;;
let vINT_LE_RNEG = vINT_OF_REAL_THM vREAL_LE_RNEG;;
let vINT_LE_SQUARE = vINT_OF_REAL_THM vREAL_LE_SQUARE;;
let vINT_LE_SQUARE_ABS = vINT_OF_REAL_THM vREAL_LE_SQUARE_ABS;;
let vINT_LE_SUB_LADD = vINT_OF_REAL_THM vREAL_LE_SUB_LADD;;
let vINT_LE_SUB_RADD = vINT_OF_REAL_THM vREAL_LE_SUB_RADD;;
let vINT_LE_TOTAL = vINT_OF_REAL_THM vREAL_LE_TOTAL;;
let vINT_LE_TRANS = vINT_OF_REAL_THM vREAL_LE_TRANS;;
let vINT_LNEG_UNIQ = vINT_OF_REAL_THM vREAL_LNEG_UNIQ;;
let vINT_LTE_ADD = vINT_OF_REAL_THM vREAL_LTE_ADD;;
let vINT_LTE_ADD2 = vINT_OF_REAL_THM vREAL_LTE_ADD2;;
let vINT_LTE_ANTISYM = vINT_OF_REAL_THM vREAL_LTE_ANTISYM;;
let vINT_LTE_TOTAL = vINT_OF_REAL_THM vREAL_LTE_TOTAL;;
let vINT_LTE_TRANS = vINT_OF_REAL_THM vREAL_LTE_TRANS;;
let vINT_LT_01 = vINT_OF_REAL_THM vREAL_LT_01;;
let vINT_LT_ADD = vINT_OF_REAL_THM vREAL_LT_ADD;;
let vINT_LT_ADD1 = vINT_OF_REAL_THM vREAL_LT_ADD1;;
let vINT_LT_ADD2 = vINT_OF_REAL_THM vREAL_LT_ADD2;;
let vINT_LT_ADDL = vINT_OF_REAL_THM vREAL_LT_ADDL;;
let vINT_LT_ADDNEG = vINT_OF_REAL_THM vREAL_LT_ADDNEG;;
let vINT_LT_ADDNEG2 = vINT_OF_REAL_THM vREAL_LT_ADDNEG2;;
let vINT_LT_ADDR = vINT_OF_REAL_THM vREAL_LT_ADDR;;
let vINT_LT_ADD_SUB = vINT_OF_REAL_THM vREAL_LT_ADD_SUB;;
let vINT_LT_ANTISYM = vINT_OF_REAL_THM vREAL_LT_ANTISYM;;
let vINT_LT_GT = vINT_OF_REAL_THM vREAL_LT_GT;;
let vINT_LT_IMP_LE = vINT_OF_REAL_THM vREAL_LT_IMP_LE;;
let vINT_LT_IMP_NE = vINT_OF_REAL_THM vREAL_LT_IMP_NE;;
let vINT_LT_LADD = vINT_OF_REAL_THM vREAL_LT_LADD;;
let vINT_LT_LE = vINT_OF_REAL_THM vREAL_LT_LE;;
let vINT_LT_LMUL_EQ = vINT_OF_REAL_THM vREAL_LT_LMUL_EQ;;
let vINT_LT_MAX = vINT_OF_REAL_THM vREAL_LT_MAX;;
let vINT_LT_MIN = vINT_OF_REAL_THM vREAL_LT_MIN;;
let vINT_LT_MUL = vINT_OF_REAL_THM vREAL_LT_MUL;;
let vINT_LT_MUL_EQ = vINT_OF_REAL_THM vREAL_LT_MUL_EQ;;
let vINT_LT_MUL2 = vINT_OF_REAL_THM vREAL_LT_MUL2;;
let vINT_LT_NEG2 = vINT_OF_REAL_THM vREAL_LT_NEG2;;
let vINT_LT_NEGTOTAL = vINT_OF_REAL_THM vREAL_LT_NEGTOTAL;;
let vINT_LT_POW2 = vINT_OF_REAL_THM vREAL_LT_POW2;;
let vINT_LT_RADD = vINT_OF_REAL_THM vREAL_LT_RADD;;
let vINT_LT_REFL = vINT_OF_REAL_THM vREAL_LT_REFL;;
let vINT_LT_RMUL_EQ = vINT_OF_REAL_THM vREAL_LT_RMUL_EQ;;
let vINT_LT_SQUARE_ABS = vINT_OF_REAL_THM vREAL_LT_SQUARE_ABS;;
let vINT_LT_SUB_LADD = vINT_OF_REAL_THM vREAL_LT_SUB_LADD;;
let vINT_LT_SUB_RADD = vINT_OF_REAL_THM vREAL_LT_SUB_RADD;;
let vINT_LT_TOTAL = vINT_OF_REAL_THM vREAL_LT_TOTAL;;
let vINT_LT_TRANS = vINT_OF_REAL_THM vREAL_LT_TRANS;;
let vINT_MAX_ACI = vINT_OF_REAL_THM vREAL_MAX_ACI;;
let vINT_MAX_ASSOC = vINT_OF_REAL_THM vREAL_MAX_ASSOC;;
let vINT_MAX_LE = vINT_OF_REAL_THM vREAL_MAX_LE;;
let vINT_MAX_LT = vINT_OF_REAL_THM vREAL_MAX_LT;;
let vINT_MAX_MAX = vINT_OF_REAL_THM vREAL_MAX_MAX;;
let vINT_MAX_MIN = vINT_OF_REAL_THM vREAL_MAX_MIN;;
let vINT_MAX_SYM = vINT_OF_REAL_THM vREAL_MAX_SYM;;
let vINT_MIN_ACI = vINT_OF_REAL_THM vREAL_MIN_ACI;;
let vINT_MIN_ASSOC = vINT_OF_REAL_THM vREAL_MIN_ASSOC;;
let vINT_MIN_LE = vINT_OF_REAL_THM vREAL_MIN_LE;;
let vINT_MIN_LT = vINT_OF_REAL_THM vREAL_MIN_LT;;
let vINT_MIN_MAX = vINT_OF_REAL_THM vREAL_MIN_MAX;;
let vINT_MIN_MIN = vINT_OF_REAL_THM vREAL_MIN_MIN;;
let vINT_MIN_SYM = vINT_OF_REAL_THM vREAL_MIN_SYM;;
let vINT_MUL_2 = vINT_OF_REAL_THM vREAL_MUL_2;;
let vINT_MUL_AC = vINT_OF_REAL_THM vREAL_MUL_AC;;
let vINT_MUL_ASSOC = vINT_OF_REAL_THM vREAL_MUL_ASSOC;;
let vINT_MUL_LID = vINT_OF_REAL_THM vREAL_MUL_LID;;
let vINT_MUL_LNEG = vINT_OF_REAL_THM vREAL_MUL_LNEG;;
let vINT_MUL_LZERO = vINT_OF_REAL_THM vREAL_MUL_LZERO;;
let vINT_MUL_POS_LE = vINT_OF_REAL_THM vREAL_MUL_POS_LE;;
let vINT_MUL_POS_LT = vINT_OF_REAL_THM vREAL_MUL_POS_LT;;
let vINT_MUL_RID = vINT_OF_REAL_THM vREAL_MUL_RID;;
let vINT_MUL_RNEG = vINT_OF_REAL_THM vREAL_MUL_RNEG;;
let vINT_MUL_RZERO = vINT_OF_REAL_THM vREAL_MUL_RZERO;;
let vINT_MUL_SYM = vINT_OF_REAL_THM vREAL_MUL_SYM;;
let vINT_NEG_0 = vINT_OF_REAL_THM vREAL_NEG_0;;
let vINT_NEG_ADD = vINT_OF_REAL_THM vREAL_NEG_ADD;;
let vINT_NEG_EQ = vINT_OF_REAL_THM vREAL_NEG_EQ;;
let vINT_NEG_EQ_0 = vINT_OF_REAL_THM vREAL_NEG_EQ_0;;
let vINT_NEG_GE0 = vINT_OF_REAL_THM vREAL_NEG_GE0;;
let vINT_NEG_GT0 = vINT_OF_REAL_THM vREAL_NEG_GT0;;
let vINT_NEG_LE0 = vINT_OF_REAL_THM vREAL_NEG_LE0;;
let vINT_NEG_LMUL = vINT_OF_REAL_THM vREAL_NEG_LMUL;;
let vINT_NEG_LT0 = vINT_OF_REAL_THM vREAL_NEG_LT0;;
let vINT_NEG_MINUS1 = vINT_OF_REAL_THM vREAL_NEG_MINUS1;;
let vINT_NEG_MUL2 = vINT_OF_REAL_THM vREAL_NEG_MUL2;;
let vINT_NEG_NEG = vINT_OF_REAL_THM vREAL_NEG_NEG;;
let vINT_NEG_RMUL = vINT_OF_REAL_THM vREAL_NEG_RMUL;;
let vINT_NEG_SUB = vINT_OF_REAL_THM vREAL_NEG_SUB;;
let vINT_NOT_EQ = vINT_OF_REAL_THM vREAL_NOT_EQ;;
let vINT_NOT_LE = vINT_OF_REAL_THM vREAL_NOT_LE;;
let vINT_NOT_LT = vINT_OF_REAL_THM vREAL_NOT_LT;;
let vINT_OF_NUM_ADD = vINT_OF_REAL_THM vREAL_OF_NUM_ADD;;
let vINT_OF_NUM_CLAUSES = vINT_OF_REAL_THM vREAL_OF_NUM_CLAUSES;;
let vINT_OF_NUM_EQ = vINT_OF_REAL_THM vREAL_OF_NUM_EQ;;
let vINT_OF_NUM_GE = vINT_OF_REAL_THM vREAL_OF_NUM_GE;;
let vINT_OF_NUM_GT = vINT_OF_REAL_THM vREAL_OF_NUM_GT;;
let vINT_OF_NUM_LE = vINT_OF_REAL_THM vREAL_OF_NUM_LE;;
let vINT_OF_NUM_LT = vINT_OF_REAL_THM vREAL_OF_NUM_LT;;
let vINT_OF_NUM_MAX = vINT_OF_REAL_THM vREAL_OF_NUM_MAX;;
let vINT_OF_NUM_MIN = vINT_OF_REAL_THM vREAL_OF_NUM_MIN;;
let vINT_OF_NUM_MOD = vINT_OF_REAL_THM vREAL_OF_NUM_MOD;;
let vINT_OF_NUM_MUL = vINT_OF_REAL_THM vREAL_OF_NUM_MUL;;
let vINT_OF_NUM_POW = vINT_OF_REAL_THM vREAL_OF_NUM_POW;;
let vINT_OF_NUM_SUB = vINT_OF_REAL_THM vREAL_OF_NUM_SUB;;
let vINT_OF_NUM_SUC = vINT_OF_REAL_THM vREAL_OF_NUM_SUC;;
let vINT_POS = vINT_OF_REAL_THM vREAL_POS;;
let vINT_POS_NZ = vINT_OF_REAL_THM vREAL_LT_IMP_NZ;;
let vINT_POW2_ABS = vINT_OF_REAL_THM vREAL_POW2_ABS;;
let vINT_POW_1 = vINT_OF_REAL_THM vREAL_POW_1;;
let vINT_POW_1_LE = vINT_OF_REAL_THM vREAL_POW_1_LE;;
let vINT_POW_1_LT = vINT_OF_REAL_THM vREAL_POW_1_LT;;
let vINT_POW_2 = vINT_OF_REAL_THM vREAL_POW_2;;
let vINT_POW_ADD = vINT_OF_REAL_THM vREAL_POW_ADD;;
let vINT_POW_EQ = vINT_OF_REAL_THM vREAL_POW_EQ;;
let vINT_POW_EQ_0 = vINT_OF_REAL_THM vREAL_POW_EQ_0;;
let vINT_POW_EQ_ABS = vINT_OF_REAL_THM vREAL_POW_EQ_ABS;;
let vINT_POW_LE = vINT_OF_REAL_THM vREAL_POW_LE;;
let vINT_POW_LE2 = vINT_OF_REAL_THM vREAL_POW_LE2;;
let vINT_POW_LE2_ODD = vINT_OF_REAL_THM vREAL_POW_LE2_ODD;;
let vINT_POW_LE2_REV = vINT_OF_REAL_THM vREAL_POW_LE2_REV;;
let vINT_POW_LE_1 = vINT_OF_REAL_THM vREAL_POW_LE_1;;
let vINT_POW_LT = vINT_OF_REAL_THM vREAL_POW_LT;;
let vINT_POW_LT2 = vINT_OF_REAL_THM vREAL_POW_LT2;;
let vINT_POW_LT2_REV = vINT_OF_REAL_THM vREAL_POW_LT2_REV;;
let vINT_POW_LT_1 = vINT_OF_REAL_THM vREAL_POW_LT_1;;
let vINT_POW_MONO = vINT_OF_REAL_THM vREAL_POW_MONO;;
let vINT_POW_MONO_LT = vINT_OF_REAL_THM vREAL_POW_MONO_LT;;
let vINT_POW_MUL = vINT_OF_REAL_THM vREAL_POW_MUL;;
let vINT_POW_NEG = vINT_OF_REAL_THM vREAL_POW_NEG;;
let vINT_POW_NZ = vINT_OF_REAL_THM vREAL_POW_NZ;;
let vINT_POW_ONE = vINT_OF_REAL_THM vREAL_POW_ONE;;
let vINT_POW_POW = vINT_OF_REAL_THM vREAL_POW_POW;;
let vINT_POW_ZERO = vINT_OF_REAL_THM vREAL_POW_ZERO;;
let vINT_RNEG_UNIQ = vINT_OF_REAL_THM vREAL_RNEG_UNIQ;;
let vINT_SGN = vINT_OF_REAL_THM real_sgn;;
let vINT_SGN_0 = vINT_OF_REAL_THM vREAL_SGN_0;;
let vINT_SGN_ABS = vINT_OF_REAL_THM vREAL_SGN_ABS;;
let vINT_SGN_ABS_ALT = vINT_OF_REAL_THM vREAL_SGN_ABS_ALT;;
let vINT_SGN_CASES = vINT_OF_REAL_THM vREAL_SGN_CASES;;
let vINT_SGN_EQ = vINT_OF_REAL_THM vREAL_SGN_EQ;;
let vINT_SGN_EQ_INEQ = vINT_OF_REAL_THM vREAL_SGN_EQ_INEQ;;
let vINT_SGN_INEQS = vINT_OF_REAL_THM vREAL_SGN_INEQS;;
let vINT_SGN_MUL = vINT_OF_REAL_THM vREAL_SGN_MUL;;
let vINT_SGN_NEG = vINT_OF_REAL_THM vREAL_SGN_NEG;;
let vINT_SGN_POW = vINT_OF_REAL_THM vREAL_SGN_POW;;
let vINT_SGN_POW_2 = vINT_OF_REAL_THM vREAL_SGN_POW_2;;
let vINT_SGN_INT_SGN = vINT_OF_REAL_THM vREAL_SGN_REAL_SGN;;
let vINT_SGNS_EQ = vINT_OF_REAL_THM vREAL_SGNS_EQ;;
let vINT_SGNS_EQ_ALT = vINT_OF_REAL_THM vREAL_SGNS_EQ_ALT;;
let vINT_SOS_EQ_0 = vINT_OF_REAL_THM vREAL_SOS_EQ_0;;
let vINT_SUB_0 = vINT_OF_REAL_THM vREAL_SUB_0;;
let vINT_SUB_ABS = vINT_OF_REAL_THM vREAL_SUB_ABS;;
let vINT_SUB_ADD = vINT_OF_REAL_THM vREAL_SUB_ADD;;
let vINT_SUB_ADD2 = vINT_OF_REAL_THM vREAL_SUB_ADD2;;
let vINT_SUB_LDISTRIB = vINT_OF_REAL_THM vREAL_SUB_LDISTRIB;;
let vINT_SUB_LE = vINT_OF_REAL_THM vREAL_SUB_LE;;
let vINT_SUB_LNEG = vINT_OF_REAL_THM vREAL_SUB_LNEG;;
let vINT_SUB_LT = vINT_OF_REAL_THM vREAL_SUB_LT;;
let vINT_SUB_LZERO = vINT_OF_REAL_THM vREAL_SUB_LZERO;;
let vINT_SUB_NEG2 = vINT_OF_REAL_THM vREAL_SUB_NEG2;;
let vINT_SUB_RDISTRIB = vINT_OF_REAL_THM vREAL_SUB_RDISTRIB;;
let vINT_SUB_REFL = vINT_OF_REAL_THM vREAL_SUB_REFL;;
let vINT_SUB_RNEG = vINT_OF_REAL_THM vREAL_SUB_RNEG;;
let vINT_SUB_RZERO = vINT_OF_REAL_THM vREAL_SUB_RZERO;;
let vINT_SUB_SUB = vINT_OF_REAL_THM vREAL_SUB_SUB;;
let vINT_SUB_SUB2 = vINT_OF_REAL_THM vREAL_SUB_SUB2;;
let vINT_SUB_TRIANGLE = vINT_OF_REAL_THM vREAL_SUB_TRIANGLE;;

let vINT_WLOG_LE = prove
 ((parse_term "(!x y:int. P x y <=> P y x) /\\ (!x y. x <= y ==> P x y) ==> !x y. P x y"),
  vMESON_TAC[vINT_LE_TOTAL]);;

let vINT_WLOG_LT = prove
 ((parse_term "(!x:int. P x x) /\\ (!x y. P x y <=> P y x) /\\ (!x y. x < y ==> P x y)\n   ==> !x y. P x y"),
  vMESON_TAC[vINT_LT_TOTAL]);;

let vINT_WLOG_LE_3 = prove
...
let vINT_SUB = vINT_ARITH (parse_term "!x y. x - y = x + --y");;

let vINT_MAX = vINT_ARITH (parse_term "!x y. max x y = if x <= y then y else x");;

let vINT_MIN = vINT_ARITH (parse_term "!x y. min x y = if x <= y then x else y");;

(* ------------------------------------------------------------------------- *)
(* Additional useful lemmas.                                                 *)
(* ------------------------------------------------------------------------- *)

let vINT_OF_NUM_EXISTS = prove
...
let vINT_DIV_UNIQ = prove
 ((parse_term "!m n q r. m = q * n + r /\\ &0 <= r /\\ r < abs n\n             ==> m div n = q"),
  vMESON_TAC[vINT_DIVMOD_UNIQ]);;

let vINT_REM_UNIQ = prove
 ((parse_term "!m n q r. m = q * n + r /\\ &0 <= r /\\ r < abs n\n             ==> m rem n = r"),
    vMESON_TAC[vINT_DIVMOD_UNIQ]);;
...
let vINT_SUB_REM = prove
 ((parse_term "!m n p. (m rem p - n rem p) rem p = (m - n) rem p"),
  vREPEAT vGEN_TAC ----> vREWRITE_TAC[vINT_REM_EQ] ----> vMATCH_MP_TAC(vINTEGER_RULE
   (parse_term "(x:int == x') (mod n) /\\ (y == y') (mod n)\n    ==> (x - y == x' - y') (mod n)")) ---->
  vREWRITE_TAC[vINT_REM_MOD_SELF]);;

let vINT_MUL_REM = prove
 ((parse_term "!m n p. (m rem p * n rem p) rem p = (m * n) rem p"),
  vREPEAT vGEN_TAC ----> vREWRITE_TAC[vINT_REM_EQ] ----> vMATCH_MP_TAC(vINTEGER_RULE
   (parse_term "(x:int == x') (mod n) /\\ (y == y') (mod n)\n    ==> (x * y == x' * y') (mod n)")) ---->
  vREWRITE_TAC[vINT_REM_MOD_SELF]);;

let vINT_POW_REM = prove
...
let vINT_DIVIDES_DIV_DIVIDES = prove
...
let vINT_DIVIDES_DIVIDES_DIV = prove
...
let vINT_DIVIDES_DIVIDES_DIV_EQ = prove
 ((parse_term "!n d e. d divides n /\\ e divides (n div d) <=> (d * e) divides n"),
...
let vDIVIDES_DIVIDES_DIV_IMP = prove
...
let vINT_CONG_NUM_EXISTS = prove
 ((parse_term "!x y:int.\n        (y = &0 ==> &0 <= x)\n        ==> ?n. (&n == x) (mod y)"),
  vREPEAT vSTRIP_TAC ---->
...
let vONE_OR_PRIME_DIVIDES_OR_COPRIME = prove
...
let vPRIME_COPRIME_EQ_NONDIVISIBLE = prove
...
let vZERO_ONE_OR_PRIME_DIVPROD = prove
...
let vREAL_ZPOW_INV = prove
 ((parse_term "!(x:real) n. inv x zpow n = inv(x zpow n)"),
  vREWRITE_TAC[vREAL_INV_ZPOW]);;

let vREAL_ZPOW_ZPOW = prove
