...
let vDIMINDEX_1 = vMATCH_MP vDIMINDEX_UNIQUE vHAS_SIZE_1;;
...
let vHAS_SIZE_FINITE_IMAGE = prove
...
let vDIMINDEX_FINITE_SUM = prove
...
let vDIMINDEX_FINITE_DIFF = prove
...
let vDIMINDEX_FINITE_PROD = prove
...
let vDIMINDEX_2 = prove
 ((parse_term "dimindex (:2) = 2"),
  vDIMINDEX_TAC ----> vREFL_TAC);;

let vDIMINDEX_3 = prove
 ((parse_term "dimindex (:3) = 3"),
  vDIMINDEX_TAC ----> vREFL_TAC);;

let vDIMINDEX_4 = prove
 ((parse_term "dimindex (:4) = 4"),
  vDIMINDEX_TAC ----> vREFL_TAC);;

let vHAS_SIZE_2 = vHAS_SIZE_DIMINDEX_RULE (parse_type "2");;
let vHAS_SIZE_3 = vHAS_SIZE_DIMINDEX_RULE (parse_type "3");;
let vHAS_SIZE_4 = vHAS_SIZE_DIMINDEX_RULE (parse_type "4");;

(* ------------------------------------------------------------------------- *)
(* Finiteness lemma.                                                         *)
(* ------------------------------------------------------------------------- *)

let vFINITE_CART = prove
...
let vIN_ELIM_PASTECART_THM = prove
...
let vIMAGE_FSTCART_PCROSS = prove
...
let vIMAGE_SNDCART_PCROSS = prove
